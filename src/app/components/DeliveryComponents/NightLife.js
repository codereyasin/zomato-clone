...
import Colloction from '../common/Colloction';
...
const NightLife = () => {
  return (
    <div>
      <Colloction list={collectionList} />
      <div className='max-width'>
        <Filter filterList={nightFilters} />
      </div>
      <ExploreSection list={nightLifeList} collectionName="Nightlife Restaurants in Bangalore"/>
    </div>
  );
};
